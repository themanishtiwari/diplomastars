...
<head>
  ...
  <title>Admin Login | Diploma Stars</title>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="footer-contact d-flex justify-content-center py-4">
                <a href="/index" class="logo">
                  <img src="assets/img/icon/diploma-stars-logo.png" alt=""> Diploma Stars
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Not for Student , Only for Admin login</p>
                  </div>
